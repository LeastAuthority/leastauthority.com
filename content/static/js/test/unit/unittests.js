...
describe('The register_callbacks callback', function () {
    //Declare variables needed to isolate and monitor the unit under test.
    var aside$, asideStripe, asidefsh, asideupdate_use_pgp, pgpcheckboxspy, jquery$spy;
    var         formsubmissionhandlerspy, update_use_pgpspy, jqueryformspy;
    beforeEach(function () {
        //Set actual objects that interract with unit under test 'aside'
        aside$ = window.$;
        asideStripe = window.Stripe;
        asidefsh = creditcardVerifier.formSubmissionHandler;
        asideupdate_use_pgp = creditcardVerifier.update_use_pgp;
        //Dereference Actual objects to isolate the unit under test.
        window.Stripe, window.$ = {};
        //Set up spies to record interractions between the unit under test and its context.
        ...
        update_use_pgpspy = jasmine.createSpy('update_use_pgp_method_spy');
        creditcardVerifier.update_use_pgp = update_use_pgpspy;
    ...
    afterEach( function () {
        ...
        creditcardVerifier.update_use_pgp = asideupdate_use_pgp;
        //Dereference spies to eliminate test specific state.
        aside$, asideStripe, asidefsh, asideupdate_use_pgp, pgpcheckboxspy, jquery$spy,+
        formsubmissionhandlerspy, update_use_pgpspy, jqueryformspy = {};
    });
    ...
    it('registers the update_use_pgp as the handler for the #use_pgp element click event', function () {
        expect(pgpcheckboxspy.click).toHaveBeenCalledWith( update_use_pgpspy );
    });
...
describe('The update_use_pgp input "checkbox" handler for the #use_pgp element',function(){
    //Declare variables needed to isolate and monitor the unit under test.
    ...
    beforeEach(function () {
        ...
        spyOn(window,"$").andCallFake(jquery$spy);
        //Invoke the unit under test.
        creditcardVerifier.update_use_pgp( jasmine.createSpy( "checked" ) );
    });
...
describe('the Stripe response handler', function (){
    //Declare variables needed to isolate and monitor the unit under test.
    var aside$, asideupdate_use_pgp, jqueryformspy, pgpcheckboxspy, checkedspy, jquerynodespy, errorfieldspy, button, jQueryspy, findspy;
